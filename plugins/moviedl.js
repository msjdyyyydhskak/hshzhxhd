...
cmd({
  ...
  try {
    ...
    filmList += `${frozenTheme.resultEmojis[9]}> 𝙿𝙾𝚆𝙴𝚁𝙳 𝙱𝚈 𝐐𝐔𝐄𝐄𝐍 𝐑𝐀𝐒𝐇𝐔 𝐌𝐃 𝙾𝙵𝙲 🫟`;
    ...
    const selectionHandler = async (update) => {
      ...
      if (repliedToId === movieListMessageKey.id) {
        ...
        downloadOptions += `${frozenTheme.resultEmojis[9]}> 𝙿𝙾𝚆𝙴𝚁𝙳 𝙱𝚈 𝐐𝐔𝐄𝐄𝐍 𝐑𝐀𝐒𝐇𝐔 𝐌𝐃 𝙾𝙵𝙲 🫟`;
